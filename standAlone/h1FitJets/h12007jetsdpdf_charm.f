**********************************************************************
c  H1 2007 Jets DPDF: charm parameterisation                         *
c--------------------------------------------------------------------*
...
c                                                                    *
c--------------------------------------------------------------------*
c This routine returns the pomeron                                   *
c charm structure functions F2_C{IP}(z,Q^2)                          *
c                                                                    *
...
**********************************************************************
      real FUNCTION  h12007jetsdpdf_charm(xin,q2in,icycle)
...
c      name='h1fitJets/h12007jetsdpdf_charm.data'
     ...
     &df_charm.data')
      ...
      if(icycle.ne.0) THEN
cKAREL      WRITE(name,282)'h12007jetsdpdf_charm',icycle
      ENDIF
...
!     CALL vzero(f(1,i),n_bin_x)                   
      ...
      enddo
      do i=1,n_bin_q2                              
c      read(28,280)(f(k,i),k=1,n_bin_x)             
...
c      q2in = qin*qin
    ...
    2 j=j-1                                        
      ...
      yd=(y-q2l_bin(j))/dy                         
      h12007jetsdpdf_charm=f(i,j)+xd*(f(i+1,j)-f(i,j))
     &+yd*(f(i,j+1)-f(i,j))                        
