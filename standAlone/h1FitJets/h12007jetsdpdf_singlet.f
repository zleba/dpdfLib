**********************************************************************
c  H1 2007 Jets DPDF: h12007jetsdpdf_singletlet density parameterisation               *
c--------------------------------------------------------------------*
...
c                                                                    *
c--------------------------------------------------------------------*
c This routine returns the pomeron h12007jetsdpdf_singletlet density (z*pdf(z,Q^2))    *
c                                                                    *
...
**********************************************************************
      real FUNCTION  h12007jetsdpdf_singlet(xin,q2in,icycle)
...
c     name='h1fitJets/h12007jetsdpdf_singlet.data'
      if(icycle.ne.0) THEN
cKAREL      WRITE(name,282)'h12007jetsdpdf_singlet',icycle
      ENDIF
...
c      q2in = qin*qin
    ...
    2 j=j-1                                        
      ...
      yd=(y-q2l_bin(j))/dy                         
      h12007jetsdpdf_singlet=f(i,j)+xd*(f(i+1,j)-f(i,j))
     &+yd*(f(i,j+1)-f(i,j))                        
